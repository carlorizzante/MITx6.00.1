...
def playGame(wordList):
    ...
    # n is HAND_SIZE, initial hand is ""
    n = HAND_SIZE
    hand = ""
    user_input = ""
    player = ""
    ...
    while True:
        ...
        # Accept only 'n', 'r', or 'e', otherwise ask them again.
        ...
        # 4) After the computer or user has played the hand, repeat from step 1r
