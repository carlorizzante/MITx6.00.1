...
def test_calculateHandlen():
    ...
    if calculateHandlen(handOrig) != expected:
        print("FAILURE: test_calculateHandlen(", handOrig, ")")
        print("\tReturned: ", calculateHandlen(handOrig), "\n\t-- but expected:", expected)
        
    # test 2
    handOrig = {'a':0, 'q':0, 'l':3, 'm':1, 'u':0, 'i':0}
    expected = 4
